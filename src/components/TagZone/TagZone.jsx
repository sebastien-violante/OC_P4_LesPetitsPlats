...
export default function TagZone({label, items,  name, isOpen, toggle, refProp}) {
    ...
    const filteredItems = useMemo(() => {
        return items.filter(item => item.toLowerCase().startsWith(isSearch.toLowerCase()))
    }, [items,isSearch]) 
        ...
        <div className={styles.tagContainer}>
            <div className={styles.tagZone}>
                <div className={styles.tagZoneHeader} >
                    ...
                    <img 
                        alt="ouvrir ou fermer la liste" 
                        className={isOpen ? styles.tagZoneArrowUp : styles.tagZoneArrowDown} 
